...
- Added a fail-closed immutable fixed-32 learned-only versus local/composed
  comparator schema v2. It binds checkpoint/config/source/standard-or-disjoint-
  manifest/posterior/schema/physical-digest and host-device provenance,
  requires real non-learned use,
